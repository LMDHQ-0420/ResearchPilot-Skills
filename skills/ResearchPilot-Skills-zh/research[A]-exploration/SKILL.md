...
description: >
  ResearchPilot 学术研究阶段 A：方向探索与调研。当用户想要从零开始探索研究方向、检索文献、
  逐步确认研究方向和研究问题（RQ）时使用此 skill。触发格式：/research[A]-exploration 后面跟研究方向描述。
  也支持独立下载论文：/research[A]-exploration download-paper 论文描述。
version: 2.0.0
license: LICENSE
---
