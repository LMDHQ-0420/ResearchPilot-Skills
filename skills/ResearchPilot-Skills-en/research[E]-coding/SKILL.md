...
description: >
  ...
  implementation design. Implements code file by file following implementation.md,
  keeps dev_log.md in sync, validates after each module, and performs a proactive
  code review on completion. Trigger: /research[E]-coding
version: 2.0.0
license: LICENSE
---
