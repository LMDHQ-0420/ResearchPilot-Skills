...
description: >
  ...
  completed experiment design. Generates a function-level coding guide
  (implementation.md) with experiment coverage, logic consistency, and
  completeness validation. Trigger: /research[D]-implementation
version: 2.0.0
license: LICENSE
---
