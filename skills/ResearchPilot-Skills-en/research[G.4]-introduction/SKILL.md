...
description: >
  CCFA research Phase G.4: Write / revise the Introduction. Five-part structure: task→SOTA failure→proposed method→additional contributions→experiment summary. Trigger: /research[G.4]-introduction
version: 2.0.0
license: LICENSE
---
