...
description: >
  ...
  completed idea deepening. Reads baseline papers and code, synthesizes field
  conventions, confirms an experiment outline before writing the full plan, and
  produces idea_report.md Part 3. Trigger: /research[C]-experiment
version: 2.0.0
license: LICENSE
---
