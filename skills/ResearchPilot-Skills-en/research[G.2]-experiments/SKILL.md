...
description: >
  CCFA research Phase G.2: Write / revise the Experiments section. Organizes analysis around three core questions. All data must come from real results/. Trigger: /research[G.2]-experiments
version: 2.0.0
license: LICENSE
---

# Phase G.2: Experiments
...
## Experiments Section-Specific Requirements

**Three Core Questions (Master-cai experiments.md)**:
1. Is the proposed method better than strong baselines? (main experiment)
2. Which modules/design choices drive the gain? (ablation)
3. How well does the method generalize? (additional analysis)
