...
CCFA-Skill 是一个 Claude Code Skill，将完整的学术研究流程自动化：从方向探索、文献检索、Idea 深化、实验设计、代码实现，到论文撰写。全程通过对话自然推进，Claude 在每个关键节点主动询问是否继续，无需记忆切换命令。
...
# 安装中文版
cp -r skills/CCFA-Skill-zh/research ~/.claude/skills/research
```
...
cp -r code/skills/CCFA-Skill-en/research ~/.claude/skills/research
```
