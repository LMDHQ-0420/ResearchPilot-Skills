...
ResearchPilot-Skills 是一个 AI 编程助手 Skill，将完整的学术研究流程自动化：从方向探索、文献检索、Idea 深化、实验设计、代码实现，到论文撰写。全程通过对话自然推进，AI 在每个关键节点主动询问是否继续，无需记忆切换命令。

支持 **Claude Code**、**OpenAI Codex CLI**、**腾讯 CodeBuddy** 等兼容 SKILL.md 标准的 AI 编程助手。
